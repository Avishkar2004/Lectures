...
app.use(express.urlencoded({ extended: false })); //check the header
...
//get all users data (HTTP HEADER LEC)
//making header
app.get("/api/users", (req, res) => {
  //custom header
  //always add X to custom header(Good Practicek)
  res.setHeader("X-myName", "Avishkar Kakde"); // got this in postman header
  //check header in postman response
